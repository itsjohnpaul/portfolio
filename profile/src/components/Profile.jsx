    ...
    >
      ...
      <motion.div
        ...
        className="
          ...
          group-hover:shadow-[0_0_30px_10px_rgba(59,130,246,0.75)]
          mx-auto md:mx-0
          flex-shrink-0
          cursor-pointer
        "
      ...
      <div className="flex flex-col items-center text-center w-full max-w-2xl transition-transform duration-500 ease-in-out group-hover:scale-105">
        ...
        <div className="mb-1">
          <motion.h2
            className="text-3xl sm:text-5xl font-semibold text-black text-left"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        {/* I AM JOHNPAUL */}
        <h1 className="text-3xl sm:text-5xl md:text-6xl font-extrabold mb-5 flex flex-wrap justify-center items-center gap-x-3 uppercase tracking-tight text-center">
          <motion.span
        ...
        {/* Subtitles */}
        <div className="flex flex-wrap items-center justify-center gap-3 mb-8 text-sm sm:text-lg font-medium text-gray-800">
          <span>WEB DEVELOPER</span>
          <span className="text-gray-400 font-normal hidden sm:block">
            |
          </span>
        ...
        <div className="w-full flex flex-row justify-center items-center gap-4 mb-8">
          <button
            ...
            className="bg-blue-700 text-white px-5 sm:px-6 py-3 rounded font-semibold shadow hover:bg-blue-800 transition cursor-pointer text-sm sm:text-base"
          >
            VIEW ME
          </button>

          <a
            href="/JohnPaul_Resume.pdf"
            target="_blank"
            rel="noopener noreferrer"
            className="border-2 border-blue-700 text-blue-700 px-5 sm:px-6 py-3 rounded font-semibold hover:bg-blue-700 hover:text-white transition inline-flex items-center justify-center cursor-pointer text-sm sm:text-base"
          >
            RESUME
          </a>
        </div>
